...
class App:
    def __init__(self):
        try:
            ...
            # GUI update pakai after (thread-safe)
            self.update_tk()
        ...
        try:
            ...
            for line in iter(proc.stdout.readline, ''):
                ...
                if code == '1':
                    ...
                    # Jika error / traceback masuk karena stderr merge
