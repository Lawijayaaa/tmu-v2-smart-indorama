...
def main():
    ...
    while True:
        ...
        cursor.execute(sqlUpdateDI, [GPIO.input(17), 1]) #PRD Trigger
        cursor.execute(sqlUpdateDI, [GPIO.input(22), 2]) #Bucholz Alarm
        cursor.execute(sqlUpdateDI, [GPIO.input(27), 3]) #Bucholz Trip
