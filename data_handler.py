...
def main():
    ...
    while progStat:
        ...
        # [PRD, Bucholz Alarm, Bucholz Trip]
        accTx = [inputIO[1][2], inputIO[2][2], inputIO[3][2]]
        ...
        if pressureStat and not accStat:
            inputData[43] = (analogIn2 - 6553) / 26214
        elif accStat and not pressureStat:
            inputData[43] = int(''.join(str(x) for x in accTx), 2) / 10
            # Bit mapping for accTx:
            # | Bit | Description     | +Value |
            # |-----|-----------------|--------|
            # | 1st | PRD             | 0.4    |
            # | 2nd | Bucholz Alarm   | 0.2    |
            # | 3rd | Bucholz Trip    | 0.1    |
            # Example: value 0.5 -> decimal 5 -> binary '101' -> accTx = [1, 0, 1]
            # (PRD active, Bucholz Alarm inactive, Bucholz Trip active)
